...
export default function PicProvinsiClientLayout({ user, children }: any) {
    ...
    <div style={{ display: 'flex', minHeight: '100vh', width: '100vw', overflowX: 'hidden', background: 'var(--bg-color)' }}>
      <aside style={{
        ...
        <div style={{ padding: '1.5rem', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
          ...
          <h2 style={{ color: 'var(--text-main)', fontWeight: 800, fontSize: '1.15rem', letterSpacing: '-0.01em' }}>{user.province}</h2>
        </div>
        <nav style={{ flex: 1, padding: '1rem 0.75rem', display: 'flex', flexDirection: 'column', gap: '0.25rem' }}>
          <Link href="/pic-provinsi/dashboard" style={{
